...
| RN-046 | Ajustar stock suma o resta una diferencia indicada por quien ajusta a la cantidad actual (no la reemplaza por una cantidad nueva); el sistema calcula la cantidad resultante para el historial y rechaza el ajuste si la dejara negativa o si la diferencia es cero (D-060). La cantidad admite hasta 3 decimales si la unidad de venta de la variante los admite; si no, tanto la diferencia como el stock mínimo deben ser un número entero (D-065). |
