...
| T-009 | Renombrar a inglés los identificadores de código de T-001 ya mergeado (tablas, columnas, clases: Organizacion, Negocio, Rol, Usuario y sus campos), con la migración correspondiente | D-034 | task/T-009-rename-to-english | Lista para revisión | Ver resumen y commit sugerido en la conversación de tarea; pendiente de que la madre corra el checklist de 10/11/12 y confirme antes de mergear. |
