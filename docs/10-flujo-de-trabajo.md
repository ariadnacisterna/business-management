...
| T-003 | Catálogo: categorías, unidades, atributos y valores, productos y variantes (alta y edición) | RF-010 a RF-017, RF-032 a RF-037, RF-040, CU-04, CU-05, CU-08, HU-04, HU-09 | task/T-003-catalog | Lista para revisión | Modelos, migración (con datos precargados del atributo `color`), dominio y endpoints de categorías, unidades, atributos/valores, productos y variantes. 16 pruebas nuevas (42 en total) corridas contra PostgreSQL real. Ver resumen del commit sugerido para detalles y ambigüedades resueltas. |
