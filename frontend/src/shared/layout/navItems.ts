...
export type NavIcon = 'panel' | 'products' | 'prices' | 'inventory' | 'sales' | 'suppliers' | 'accounts'
...
export const NAV_ITEMS: NavItem[] = [
  ...
  { to: '/proveedores', label: 'Proveedores', icon: 'suppliers', disabled: true, minRole: 'Administrador' },
